            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item active">Pelanggan / Blacklist</li>
                    </ol>
                </div><!-- /.col -->
            </div><!-- /.row -->
        </div><!-- /.container-fluid -->
                        ...
                        <div class="card-body p-0">
                            <div class="table-responsive">
                                <table class="table m-0">
                                    ...
                                    <tbody>
                                        <?php
                                        $varBlack = "SELECT p.id_pengguna, p.username, p.id_level, l.level_name, p.tgl_daftar, p.status_akun 
                                            FROM tb_pengguna p INNER JOIN tb_level l ON l.id_level=p.id_level WHERE p.status_akun = 'Blocked' ORDER BY p.tgl_daftar";
                                        $varQueryBlack = mysqli_query($conn, $varBlack);
                                        $varCountBlack = mysqli_num_rows($varQueryBlack);
                                        if ($varCountBlack > 0) {
                                            while ($dataBlack = mysqli_fetch_array($varQueryBlack)) {
                                        ?>
                                                <tr>
                                                    <td><a href="#"><?= $dataBlack['id_pengguna']; ?></a></td>
                                                    <td><?= $dataBlack['username']; ?></td>
                                                    <td><?= $dataBlack['level_name']; ?></td>
                                                    <td><?= $dataBlack['tgl_daftar']; ?></td>
                                                    <td><span class="badge badge-primary"><?= $dataBlack['status_akun']; ?></span></td>
